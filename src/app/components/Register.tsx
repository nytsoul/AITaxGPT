    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 py-12 px-4 relative overflow-hidden">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Join TaxGPT</h1>
          <p className="text-slate-500 mt-2">Start your journey toward tax intelligence</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-500">
          ...
          <a href="/login" className="font-bold text-teal-600 hover:text-teal-700 transition-colors">
            Log In
          </a>
        </p>
      </motion.div>
